          ...
          {image && (
            <div 
              className={`w-full h-full rounded relative overflow-hidden mesh-gradient ${
                image === "mesh-gradient-1" ? "bg-gradient-to-br from-purple-500 via-pink-500 to-red-500" :
                image === "mesh-gradient-2" ? "bg-gradient-to-br from-blue-500 via-purple-500 to-indigo-500" :
                image === "mesh-gradient-3" ? "bg-gradient-to-br from-green-500 via-teal-500 to-cyan-500" :
                image === "mesh-gradient-4" ? "bg-gradient-to-br from-orange-500 via-red-500 to-pink-500" :
                image === "mesh-gradient-5" ? "bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500" :
                "bg-gradient-to-br from-gray-500 to-gray-600"
              }`}
            >
              {/* Animated overlay for extra visual appeal */}
              <div className="absolute inset-0 bg-gradient-to-t from-black/20 via-transparent to-white/10 animate-pulse" />
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent animate-pulse" style={{ animationDelay: '1s' }} />
            </div>
          )}
        </div>
        <div
