export default function FooterSection() {
      ...
      <div className="w-full flex flex-col md:flex-row justify-between items-center px-4 py-6 gap-6">
        ...
        <div className="flex items-center gap-4">
          <a className="w-6 h-6 flex items-center justify-center cursor-pointer">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="#49423D">
        ...
        {/* Center: Brand */}
        <div className="text-[#49423D] text-lg font-semibold font-sans">
          GitOSS
        </div>
  ...
  className="flex items-center gap-1 text-[#49423D] text-sm font-medium font-sans hover:text-[#37322F] transition-colors"
>
  <svg
    width="14"
    height="14"
